...
export default function CertificateResponseItem(props) {
    ...
    function handleClick() {
        ...
        const url = "https://ec2-35-165-164-205.us-west-2.compute.amazonaws.com:8081/admin/certificate/verify/" + licenseNo;
        axios({
            url: url,
            method: "PUT",
            headers: {
    ...
    function handleExpireClick(){
        const licenseNo = licenseRef.current.value;
        const url = "https://ec2-35-165-164-205.us-west-2.compute.amazonaws.com:8081/admin/certificate/expire/" + licenseNo;
        axios({
            url: url,
            method: "PUT",
            headers: {
    ...
    function handleDeleteClick(){
        const licenseNo = licenseRef.current.value;
        const url = "https://ec2-35-165-164-205.us-west-2.compute.amazonaws.com:8081/admin/certificate/delete/" + licenseNo;
        axios({
            url: url,
            method: "DELETE",
            headers: {
