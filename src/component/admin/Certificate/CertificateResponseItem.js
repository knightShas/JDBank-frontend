...
export default function CertificateResponseItem(props) {
    ...
    function handleClick() {
        ...
        const url = "https://spring-seller-certification.herokuapp.com/admin/certificate/verify/" + licenseNo;
        axios({
            url: url,
            method: "PUT",
            headers: {
    ...
    function handleExpireClick(){
        const licenseNo = licenseRef.current.value;
        const url = "https://spring-seller-certification.herokuapp.com/admin/certificate/expire/" + licenseNo;
        axios({
            url: url,
            method: "PUT",
            headers: {
    ...
    function handleDeleteClick(){
        const licenseNo = licenseRef.current.value;
        const url = "https://spring-seller-certification.herokuapp.com/admin/certificate/delete/" + licenseNo;
        axios({
            url: url,
            method: "DELETE",
            headers: {
