...
export default function TopPerformer() {
    ...
    useEffect(() => {
        const url = "http://ec2-35-89-199-189.us-west-2.compute.amazonaws.com:8081/admin/agent/top/performer";
        ...
        const fetchData = async () => {
            try {
                ...
                setAgent(json);
                const rewardUrl = "http://ec2-35-89-199-189.us-west-2.compute.amazonaws.com:8081/reward/" + json['email'];
                try {
