...
export default function AgentItem(props) {
    ...
    function handleClick() {
        ...
        const url = "https://ec2-34-220-127-234.us-west-2.compute.amazonaws.com:8081/admin/agent/authorize/" + agentEmail;
        axios({
            url: url,
            method: "PUT",
            headers: {
    ...
    function handleDeleteClick() {
        const agentEmail = agentEmailRef.current.value;
        const url = "https://ec2-34-220-127-234.us-west-2.compute.amazonaws.com:8081/admin/agent/delete/" + agentEmail;
        axios({
            url: url,
            method: "DELETE",
            headers: {
